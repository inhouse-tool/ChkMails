...
`デジタル署名` のタブで下記のように `2026年6月21日` 付けのデジタル署名が付いていることが確認できます.
...
* インストールされる `ChkMails.exe` にも署名があり, `2026年6月21日 11:02:42` となっています.
インストール後にでもご確認ください.
* 同梱されている `CharaMap.exe` の署名も, 同じく `2026年6月21日 11:02:43` となっています.
併せてご確認ください.
