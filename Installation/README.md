...
> [!NOTE]
> 以下 Microsoft Edge&reg; の画像例をいくつか掲げていますが,
Microsoft Edge&reg; ってしょっちゅう改版するので画像例の見てくれも少々古くなっています.
しかし段取りは全く変わっていないので, 以下の説明の通りインストールは進めていただいて構いません.
<br><sup>(
より新しい画像を使った例が[こちら](https://github.com/inhouse-tool/Detag/blob/main/docs/Installation.md)にあることはあります.
)</sup>
...
`デジタル署名` のタブで下記のように `2026年9月20日` 付けのデジタル署名が付いていることが確認できます.
...
`2026年9月20日 11:11:17`
1. この署名に立ち会った `DigiCert` が 副署名を施したのも
`2026年9月20日 11:11:17`

と, 両者の日時が一致しています.
上記 1. だけなら署名者が自分の PC の時計をいじくって日時を捏造することも可能かもしれませんが,
この署名に立ち会った `DigiCert`
( フルネームが `DigiCert SHA256 RSA4096 Timestamp Responder 2025 1` という時間にうるさそうな第三者 )
の時計までいじることは不可能です.
...
* インストールされる `ChkMails.exe` にも署名があり, `2026年9月20日 11:11:14` となっています.
インストール後にでもご確認ください.
...
<br>
<sup>
▲ 「インストーラーはインストールする準備ができてる」と言ってくるインストーラー
</sup>
