...
Explorer がフォルダー表示を抽象化するので, よく解らないことになっていますが, <sub>( 余計なお世話だと思いません? )</sub>
...
にあるはずです.
そこまで迎えに行ってそこに居た `ChkMails.msi` をダブルクリックすると,
...
下記のように `2025年 1月 11日 11:15:06` 付けのデジタル署名が付いています
( インストール後の `ChkMails.exe` は `2025年 1月 11日 11:15:03` ).
